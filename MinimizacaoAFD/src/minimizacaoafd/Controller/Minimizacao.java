...
public class Minimizacao {
    ...
    /**
     * Minimiza o afd, gera a tabela, salva o afd minimizado em um arquivo,
     * salva a tabela gerada em um arquivo.
     */
    ...
    /**
     * Gera a tabela inicial do algoritmo e também ja diz quais indices sao
     * estados finais com nao finais.
     */
     ...
     *
     * @param l linha que nao pode se juntar e suas dependencias devem ser
     * resolvidas.
    ...
    /**
     * Gera e retorna a lista com os conjuntos juntaveis, ou seja, cada elemento
     * desta lista é um conjunto com estados que podem se juntar.
     *
     * @return
     */
    ...
    /**
     * Dado o estado ele verifica se ele e formador de um novo estado, caso seja
     * e retornado o estado que ele se torna, senao e retornado ele mesmo.
     *
     * @param e
     * @param doQueSaoFormadosOsNovosEstados
     * @param novosEstados
    ...
    /**
     * Método privado que salva os resultados do algoritmo de minimização. Salva
     * o AFD minimizado em um arquivo e a tabela do algoritmo de minimização em
     * um outro arquivo
     *
     * @throws IOException Se der algum erro ao escrever no arquivo será
     * retornado uma excessão com a mensagem de erro
     */
